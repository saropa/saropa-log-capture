...
export const stringsViewerB: Record<string, string> = {
    ...
    'viewer.session.toggleCollapseCounts.title': 'Show full severity counts only on latest and active logs',
    'viewer.session.toggleCollapseCounts.label': 'Collapse severity counts on older logs',
    'viewer.session.toggleCollapseCounts.text': 'Collapse counts',
    'viewer.session.expandAllDays.title': 'Expand all day groups',
    'viewer.session.expandAllDays.label': 'Expand all day groups',
    'viewer.session.expandAllDays.text': 'Expand all',
    'viewer.session.collapseAllDays.title': 'Collapse all day groups',
    'viewer.session.collapseAllDays.label': 'Collapse all day groups',
    'viewer.session.collapseAllDays.text': 'Collapse all',
