...
export const stringsA: Record<string, string> = {
    ...
    'msg.suiteSilentAdvisor': '{0} is installed but has not shared any data yet. Start a Drift debug session so it can analyze your database, and its findings will appear here.',
    'msg.suiteSilentLints': '{0} is installed but has not shared any findings yet. Make sure its analyzer is running for this project, and its results will appear here.',
    'msg.suiteSilentStale': '{0} shared data from an earlier commit. Re-run it on your current code to refresh what appears here.',
    ...
    'msg.foundCorrelationTags.one': 'Found {0} correlation tag.',
    'msg.foundCorrelationTags.many': 'Found {0} correlation tags.',
    'msg.suiteDeepLinkFailed': 'Could not open {0}. The Saropa sibling extension may be out of date or disabled.',
    'msg.adapterRecommend.prompt': '{0} detected in your project. Saropa Log Capture can capture {1}. Turn on?',
    'msg.adapterRecommend.enable': 'Turn On',
    'msg.adapterRecommend.choose': 'Choose…',
    'msg.adapterRecommend.enabled': 'Enabled {0}.',
    ...
    'msg.needThreeSessions': 'Need at least 3 logs to compare three ways.',
    'prompt.selectBaseline': 'Select the BASELINE log (A)',
    'prompt.selectRunB': 'Select run B',
    'prompt.selectRunC': 'Select run C',
    'title.compare3Baseline': 'Compare 3 Logs · Baseline (1/3)',
    'title.compare3RunB': 'Compare 3 Logs · Run B (2/3)',
    'title.compare3RunC': 'Compare 3 Logs · Run C (3/3)',
    ...
    'msg.deleteAllBookmarks.one': 'Delete all {0} bookmark?',
    'msg.deleteAllBookmarks.many': 'Delete all {0} bookmarks?',
    ...
    'msg.exportedLinesTo.one': 'Exported {0} line{1} to {2}',
    'msg.exportedLinesTo.many': 'Exported {0} lines{1} to {2}',
