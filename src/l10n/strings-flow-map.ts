...
export const stringsFlowMap: Record<string, string> = {
    ...
    'flowMap.shot.title': 'Screenshot',
    'flowMap.shot.captured': 'Captured',
    'flowMap.shot.trigger': 'Trigger',
    'flowMap.shot.screen': 'Screen',
    'flowMap.shot.logLine': 'Log line',
    'flowMap.shot.close': 'Close',
    'flowMap.shot.counter': 'Capture {0} of {1}',
    'flowMap.shot.counterScreen': 'Capture {0} of {1} on this screen',
    'flowMap.shot.file': 'File',
    'flowMap.shot.copyPath': 'Copy full path',
    'flowMap.shot.pathCopied': 'Screenshot path copied',
    'flowMap.shot.zoom': 'Zoom',
    ...
    'flowMap.shot.comparePrev': 'Previous capture of this screen',
    'flowMap.shot.compareNext': 'Next capture of this screen',
    'flowMap.shot.compareSession': 'Compare against another session',
    'flowMap.shot.compareThisSession': 'This session',
    'flowMap.shot.compareLoading': 'Reading that session…',
    'flowMap.shot.compareNoMatch': 'That session has no capture of this screen',
