...
export const stringsWebviewB: Record<string, string> = {
    ...
    'viewer.sqlHistory.issues.loading': 'Checking for database issues…',
    'viewer.sqlHistory.issues.error': 'Could not load database issues',
    'viewer.sqlHistory.lint.title': 'Static code issues (Saropa Lints)',
    'viewer.sqlHistory.lint.loading': 'Checking static code issues…',
    'viewer.sqlHistory.lint.error': 'Could not load static code issues',
