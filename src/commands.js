...
const commands_insights_1 = require("./commands-insights");
...
const commands_investigation_1 = require("./commands-investigation");
...
function registerCommands(deps) {
    ...
    context.subscriptions.push(...(0, commands_session_1.sessionLifecycleCommands)(deps), ...(0, commands_session_1.sessionActionCommands)(deps), ...(0, commands_session_1.historyBrowseCommands)(deps), ...(0, commands_session_1.historyEditCommands)(deps), ...(0, commands_export_1.exportCommands)(deps), ...(0, commands_comparison_1.comparisonCommands)(context.extensionUri, deps.broadcaster), ...correlationCommands(deps), ...(0, commands_insights_1.insightsCommands)(deps), ...(0, commands_bug_report_1.bugReportCommands)({ getFileUri: () => deps.viewerProvider.getCurrentFileUri(), context }), ...(0, commands_quality_1.qualityCommands)({ getFileUri: () => deps.viewerProvider.getCurrentFileUri() }), ...(0, commands_timeline_1.timelineCommands)(), ...(0, commands_trash_1.trashCommands)(deps.historyProvider, () => deps.viewerProvider.getCurrentFileUri()), ...(0, commands_investigation_1.registerInvestigationCommands)({ context, investigationStore, historyProvider: deps.historyProvider, viewerProvider: deps.viewerProvider }), ...(0, commands_tools_1.toolCommands)(deps), ...(0, commands_external_logs_1.externalLogsCommands)(deps), ...(0, commands_learning_1.learningCommands)(deps), walkthroughCommand());
}
