...
const highlight_rules_1 = require("../../../modules/storage/highlight-rules");
suite('HighlightRules', () => {
    suite('parseHighlightPattern', () => {
        test('should return undefined for empty pattern', () => {
            assert.strictEqual((0, highlight_rules_1.parseHighlightPattern)(''), undefined);
        });
        test('should parse plain string as case-insensitive regex', () => {
            const regex = (0, highlight_rules_1.parseHighlightPattern)('error');
            assert.ok(regex);
        ...
        test('should parse regex pattern with flags', () => {
            const regex = (0, highlight_rules_1.parseHighlightPattern)('/Error.*null/i');
            assert.ok(regex);
        ...
        test('should return undefined for invalid regex', () => {
            const regex = (0, highlight_rules_1.parseHighlightPattern)('/[invalid/');
    ...
    suite('compileHighlightRules', () => {
        test('should compile valid rules', () => {
            ...
            const compiled = (0, highlight_rules_1.compileHighlightRules)(rules);
    ...
    suite('matchHighlightRules', () => {
        test('should return undefined for empty rules', () => {
            const match = (0, highlight_rules_1.matchHighlightRules)('any text', []);
        ...
        test('should match simple pattern', () => {
            ...
            const compiled = (0, highlight_rules_1.compileHighlightRules)(rules);
            const match = (0, highlight_rules_1.matchHighlightRules)('Error occurred', compiled);
            assert.ok(match);
        ...
        test('should match multiple patterns', () => {
            ...
            const compiled = (0, highlight_rules_1.compileHighlightRules)(rules);
            const match = (0, highlight_rules_1.matchHighlightRules)('Fatal error occurred', compiled);
            assert.ok(match);
            assert.strictEqual(match.styles.color, 'red');
        ...
        test('should use first match for conflicting styles', () => {
            ...
            const compiled = (0, highlight_rules_1.compileHighlightRules)(rules);
            const match = (0, highlight_rules_1.matchHighlightRules)('Fatal error', compiled);
            assert.ok(match);
        ...
        test('should return undefined when no rules match', () => {
            ...
            const compiled = (0, highlight_rules_1.compileHighlightRules)(rules);
            const match = (0, highlight_rules_1.matchHighlightRules)('All is well', compiled);
            assert.strictEqual(match, undefined);
        });
        test('should apply bold and italic styles', () => {
            ...
            const compiled = (0, highlight_rules_1.compileHighlightRules)(rules);
            const match = (0, highlight_rules_1.matchHighlightRules)('This is important', compiled);
            assert.ok(match);
    ...
    suite('stylesToCss', () => {
        test('should return empty string for empty styles', () => {
            const css = (0, highlight_rules_1.stylesToCss)({});
            assert.strictEqual(css, '');
        });
        test('should generate CSS for color', () => {
            const css = (0, highlight_rules_1.stylesToCss)({ color: 'red' });
    ...
    suite('HighlightRulesManager', () => {
        test('should start with no rules', () => {
            const manager = new highlight_rules_1.HighlightRulesManager();
...
//# sourceMappingURL=highlight-rules.test.js.map