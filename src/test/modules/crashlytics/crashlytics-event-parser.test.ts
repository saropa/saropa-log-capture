...
import { parseEventResponse } from '../../../modules/crashlytics/crashlytics-event-parser';

suite('CrashlyticsEventParser', () => {

    suite('parseEventResponse', () => {
        test('should return undefined for empty data', () => {
            assert.strictEqual(parseEventResponse('issue-1', {}), undefined);
        });

        test('should return undefined for empty events array', () => {
            assert.strictEqual(parseEventResponse('issue-1', { events: [] }), undefined);
        });
        ...
        test('should parse structured threads', () => {
            ...
            const result = parseEventResponse('issue-1', data);
            assert.ok(result);
        ...
        test('should return undefined for short/empty stack trace', () => {
            assert.strictEqual(parseEventResponse('issue-1', { stackTrace: 'short' }), undefined);
        });
