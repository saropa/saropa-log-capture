...
import { parseJsonlChunk } from '../../../modules/ai/ai-jsonl-parser';
...
suite('AiJsonlParser', () => {
    ...
    suite('parseJsonlChunk', () => {
        ...
        test('should return empty array for empty input', () => {
            assert.deepStrictEqual(parseJsonlChunk(''), []);
        });
        ...
        test('should return empty array for invalid JSON lines', () => {
            assert.deepStrictEqual(parseJsonlChunk('not json'), []);
        });
        ...
        test('should parse user prompt entry', () => {
            ...
            const results = parseJsonlChunk(line);
        ...
        test('should skip non-external user entries', () => {
            ...
            assert.deepStrictEqual(parseJsonlChunk(line), []);
        });
        ...
        test('should deduplicate streaming assistant messages by message ID', () => {
            ...
            const results = parseJsonlChunk(`${msg1}\n${msg2}`);
        ...
        test('should handle multiple lines of different types', () => {
            ...
            const results = parseJsonlChunk(lines);
