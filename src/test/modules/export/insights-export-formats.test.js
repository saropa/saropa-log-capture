...
suite('InsightsExportFormats', () => {
    suite('formatInsightsSummaryToCsv', () => {
        test('should produce CSV with headers for empty summary', () => {
            const csv = (0, insights_export_formats_1.formatInsightsSummaryToCsv)(minimalSummary());
    ...
    suite('formatInsightsSummaryToJson', () => {
        test('should produce valid JSON for empty summary', () => {
            const json = (0, insights_export_formats_1.formatInsightsSummaryToJson)(minimalSummary());
...
//# sourceMappingURL=insights-export-formats.test.js.map