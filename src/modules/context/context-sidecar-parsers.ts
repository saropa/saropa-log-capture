 ...
 */
export function loadPerfContext(content: string, window: ContextWindow): Partial<ContextData> {
 ...
 */
export function loadTerminalContext(content: string, window: ContextWindow): Partial<ContextData> {
 ...
 */
export function extractTimestamp(obj: Record<string, unknown>): number {
