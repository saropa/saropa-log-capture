...
export interface ViewerSlowBurstThresholds {
...
export const VIEWER_SLOW_BURST_DEFAULTS: ViewerSlowBurstThresholds = {
  slowQueryMs: 50,
  burstMinCount: 5,
  burstWindowMs: 2000,
  cooldownMs: 10_000,
...
export function normalizeViewerSlowBurstThresholds(
  partial?: Partial<ViewerSlowBurstThresholds>,
): ViewerSlowBurstThresholds {
  const d = VIEWER_SLOW_BURST_DEFAULTS;
  return {
