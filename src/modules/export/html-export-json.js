...
exports.wrapJsonInLine = wrapJsonInLine;
...
function wrapJsonInLine(html) {
    ...
    return `${prefix}<span class="json-collapsible"><span class="json-toggle">▶</span><span class="json-preview">${(0, ansi_1.escapeHtml)(preview)}</span><pre class="json-expanded hidden">${(0, ansi_1.escapeHtml)(pretty)}</pre></span>${suffix}`;
}
/**
 ...
 */
function detectJsonInHtml(html) {
...
//# sourceMappingURL=html-export-json.js.map