...
exports.getMidnightFromTimestamp = getMidnightFromTimestamp;
 ...
 */
function parseTimestamp(text, sessionStart) {
 ...
 */
function extractTimestamp(line, sessionStart) {
 ...
 */
function getMidnightFromTimestamp(timestamp) {
 ...
 */
function formatTimestampShort(epoch) {
    if (epoch === 0) {
        return '';
    }
    const d = new Date(epoch);
...
//# sourceMappingURL=timestamp-parser.js.map