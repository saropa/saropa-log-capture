...
exports.createIntegrationContext = createIntegrationContext;
exports.createIntegrationEndContext = createIntegrationEndContext;
const vscode = __importStar(require("vscode"));
/** Context passed to providers at session start (sync and async). */
function createIntegrationContext(sessionContext, config, outputChannel, extensionContext) {
    return {
        sessionContext,
...
function createIntegrationEndContext(params) {
