...
exports.INTEGRATION_ADAPTERS = [
    ...
    },
    {
        ...
        descriptionLong: 'Spawns `adb logcat` when a debug session starts and streams Android system log lines into the viewer in real time. Lines are classified by logcat level (V/D/I/W/E/F/A), filtered by the debug target PID once known, and written to a .logcat.log sidecar at session end.',
