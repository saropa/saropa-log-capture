...
exports.scheduleMaybeAutoEnableAiFromLanguageModels = scheduleMaybeAutoEnableAiFromLanguageModels;
const vscode = __importStar(require("vscode"));
function scheduleMaybeAutoEnableAiFromLanguageModels() {
    void (async () => {
        try {
            const aiCfg = vscode.workspace.getConfiguration('saropaLogCapture.ai');
            const inspected = aiCfg.inspect('enabled');
            const userTouched = inspected?.globalValue !== undefined ||
...
//# sourceMappingURL=ai-auto-enable.js.map