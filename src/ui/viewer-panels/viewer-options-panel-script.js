...
exports.getOptionsPanelScript = getOptionsPanelScript;
const viewer_options_events_1 = require("./viewer-options-events");
const viewer_options_integrations_helper_1 = require("./viewer-options-integrations-helper");
const viewer_options_panel_views_1 = require("./viewer-options-panel-views");
/** Returns the JavaScript code for the options panel. */
function getOptionsPanelScript() {
    return /* javascript */ `
...
${(0, viewer_options_panel_views_1.getOptionsPanelViewsScript)()}
${(0, viewer_options_integrations_helper_1.getOptionsIntegrationsHelperScript)()}
...
${(0, viewer_options_events_1.getOptionsEventHandlers)()}
`;
}
//# sourceMappingURL=viewer-options-panel-script.js.map