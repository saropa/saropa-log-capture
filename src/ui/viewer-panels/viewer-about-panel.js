...
exports.getAboutPanelHtml = getAboutPanelHtml;
exports.getAboutPanelScript = getAboutPanelScript;
const marketplace_url_1 = require("../../modules/marketplace-url");
/** Generate the about panel HTML with static content. */
function getAboutPanelHtml() {
    return /* html */ `
...
function getProjectLinksHtml() {
    return [
        ...
        linkHtml({ icon: '\u{1F4CB}', title: 'Saropa Log Capture',
            ...
            url: (0, marketplace_url_1.buildItemUrl)('saropa.saropa-log-capture') }),
        linkHtml({ icon: '\u{1F6E1}\uFE0F', title: 'Saropa Claude Guard', badge: 'VS Code Marketplace',
            ...
            url: (0, marketplace_url_1.buildItemUrl)('Saropa.saropa-claude-guard') }),
...
//# sourceMappingURL=viewer-about-panel.js.map