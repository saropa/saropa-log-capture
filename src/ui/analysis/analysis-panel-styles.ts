...
body { background: var(--vscode-editor-background); color: var(--vscode-editor-foreground); font-family: var(--vscode-font-family, sans-serif); font-size: var(--text-body); }
.header { padding: var(--space-3) var(--space-4); background: var(--vscode-sideBar-background); border-bottom: 1px solid var(--vscode-panel-border); }
.analyzed-line { font-family: var(--vscode-editor-font-family, monospace); font-size: 12px; color: var(--vscode-descriptionForeground); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; margin-bottom: var(--space-1); }
.summary { font-size: var(--text-caption); color: var(--vscode-descriptionForeground); }
...
.group { margin-bottom: var(--space-2); border: 1px solid var(--vscode-panel-border); border-radius: 4px; }
...
.match-count { font-weight: normal; color: var(--vscode-descriptionForeground); font-size: var(--text-caption); margin-left: var(--space-2); }
...
.file-name { padding: var(--space-1) var(--space-2); font-size: 12px; font-weight: 500; color: var(--vscode-textLink-foreground); }
...
.section-slot { margin-bottom: var(--space-2); border: 1px solid var(--vscode-panel-border); border-radius: 4px; overflow: hidden; transition: opacity 0.3s ease; }
.section-loading { display: flex; align-items: center; gap: var(--space-2); padding: 10px 12px; color: var(--vscode-descriptionForeground); font-size: 12px; animation: pulse 1.2s ease-in-out infinite; }
...
.executive-summary { margin: var(--space-2); padding: var(--space-3) var(--space-4); background: var(--vscode-editorWidget-background); border: 1px solid var(--vscode-editorWidget-border, var(--vscode-panel-border)); border-left: 3px solid var(--vscode-editorInfo-foreground, var(--accent-info)); border-radius: 4px; animation: fadeIn 0.3s ease; }
...
.diff-summary { padding: 6px 12px; font-family: var(--vscode-editor-font-family, monospace); font-size: var(--text-caption); color: var(--vscode-descriptionForeground); border-bottom: 1px solid var(--vscode-panel-border); }
...
.related-src { color: var(--vscode-descriptionForeground); font-size: var(--text-caption); margin-left: auto; flex-shrink: 0; }
...
.ref-file-meta { font-size: var(--text-caption); color: var(--vscode-descriptionForeground); margin-top: 2px; }
...
.fb-meta { font-size: var(--text-caption); color: var(--vscode-descriptionForeground); margin-top: 2px; }
...
.crash-detail.expanded { max-height: 2000px; padding: var(--space-1) 0; border-top: 1px solid var(--vscode-panel-border); }
.crash-thread-header { padding: var(--space-1) var(--space-3); font-size: var(--text-caption); font-weight: 600; color: var(--vscode-descriptionForeground); }
...
.crash-thread-more { padding: 6px 12px 0; font-size: var(--text-caption); color: var(--vscode-descriptionForeground); font-style: italic; }
.crash-loading { padding: 6px 24px; font-size: 12px; display: flex; align-items: center; gap: var(--space-2); color: var(--vscode-descriptionForeground); }
...
.crash-device-meta { padding: var(--space-1) var(--space-3); font-size: var(--text-caption); color: var(--vscode-descriptionForeground); }
...
.crash-dist-label { padding: var(--space-1) var(--space-3); font-size: var(--text-caption); font-weight: 600; color: var(--vscode-descriptionForeground); }
...
.crash-ai-summary { padding: var(--space-2) var(--space-3); margin: var(--space-1) 0; background: var(--vscode-editorWidget-background); border: 1px solid var(--vscode-editorWidget-border, var(--vscode-panel-border)); border-left: 3px solid var(--vscode-editorInfo-foreground, var(--accent-info)); border-radius: 4px; font-size: 12px; line-height: 1.5; white-space: pre-wrap; animation: fadeIn 0.3s ease; }`;
}
