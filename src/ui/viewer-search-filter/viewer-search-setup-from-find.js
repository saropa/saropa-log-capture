...
exports.getSearchSetupFromFindInFilesScript = getSearchSetupFromFindInFilesScript;
/** Returns JS assigned to `window.setupFromFindInFiles` (no wrapping IIFE). */
function getSearchSetupFromFindInFilesScript() {
    return /* javascript */ `
...
//# sourceMappingURL=viewer-search-setup-from-find.js.map