...
exports.getSourceTagsHtml = getSourceTagsHtml;
exports.getSourceTagsScript = getSourceTagsScript;
const viewer_source_tags_ui_1 = require("./viewer-source-tags-ui");
/** Returns empty HTML — log tags now live inside the filters panel. */
function getSourceTagsHtml() {
    return '';
}
/** Returns the JavaScript for source tag parsing, tracking, and filtering. */
function getSourceTagsScript() {
    return /* javascript */ `
var sourceTagCounts = {};
...
${(0, viewer_source_tags_ui_1.getSourceTagUiScript)()}
`;
}
//# sourceMappingURL=viewer-source-tags.js.map