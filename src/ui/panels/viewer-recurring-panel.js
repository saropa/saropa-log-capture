...
exports.getRecurringPanelHtml = getRecurringPanelHtml;
exports.getRecurringPanelScript = getRecurringPanelScript;
/** Generate the recurring errors panel HTML. */
function getRecurringPanelHtml() {
    return /* html */ `
...
function getRecurringPanelScript() {
    return /* js */ `
(function() {
    ...
    var footerSignals = document.getElementById('recurring-footer-signals');
    if (footerSignals) footerSignals.addEventListener('click', function() {
        vscodeApi.postMessage({ type: 'openSignals' });
    });
...
//# sourceMappingURL=viewer-recurring-panel.js.map