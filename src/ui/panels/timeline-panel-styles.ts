...
body { background: var(--surface-1); color: var(--vscode-editor-foreground); font-family: var(--vscode-font-family, sans-serif); font-size: var(--text-body); height: 100vh; display: flex; flex-direction: column; overflow: hidden; }

.header { padding: 10px var(--space-4); background: var(--vscode-sideBar-background); border-bottom: 1px solid var(--border); flex-shrink: 0; }
.title { font-size: var(--text-label); font-weight: 600; margin-bottom: 2px; }
.subtitle { font-size: var(--text-caption); color: var(--muted); }

.toolbar { display: flex; flex-wrap: wrap; gap: var(--space-3); padding: var(--space-2) var(--space-4); border-bottom: 1px solid var(--border); background: var(--vscode-sideBar-background); flex-shrink: 0; align-items: center; }
...
.stats-bar { display: flex; gap: var(--space-3); font-size: var(--text-caption); color: var(--muted); }
.stat-item { display: flex; align-items: center; gap: var(--space-1); }
.stat-dot { width: 8px; height: 8px; border-radius: 50%; }
.stat-dot.error { background: var(--accent-critical); }
.stat-dot.warning { background: var(--accent-warning); }
...
.time-scrubber { display: flex; align-items: center; gap: 10px; padding: var(--space-2) var(--space-4); border-bottom: 1px solid var(--border); flex-shrink: 0; }
.time-label { font-family: var(--vscode-editor-font-family, monospace); font-size: var(--text-caption); color: var(--muted); min-width: 60px; }
.time-label.end { text-align: right; }
.scrubber-track { flex: 1; height: 20px; background: var(--inset); border-radius: 4px; position: relative; cursor: pointer; }
...
.minimap { display: flex; align-items: flex-end; gap: 1px; height: 36px; padding: 3px 16px; background: var(--vscode-sideBar-background); border-bottom: 1px solid var(--border); flex-shrink: 0; position: relative; cursor: pointer; }
...
.event-time { width: 65px; flex-shrink: 0; font-family: var(--vscode-editor-font-family, monospace); font-size: var(--text-caption); color: var(--muted); text-align: right; }
.event-icon { width: 14px; flex-shrink: 0; text-align: center; font-size: var(--text-caption); }
.level-error .event-icon { color: var(--accent-critical); }
.level-warning .event-icon { color: var(--accent-warning); }
.level-perf .event-icon { color: var(--vscode-charts-purple, var(--accent-opinionated)); }
.level-debug .event-icon, .level-info .event-icon { color: var(--muted); }
...
.level-error { background: color-mix(in srgb, var(--accent-critical) 8%, transparent); }
.level-warning { background: color-mix(in srgb, var(--accent-warning) 5%, transparent); }

.correlation-badge { color: var(--link); cursor: pointer; margin-left: var(--space-1); }
...
.timeline-correlations { padding: var(--space-2) var(--space-4); border-bottom: 1px solid var(--border); background: var(--vscode-sideBar-background); flex-shrink: 0; }
...
.timeline-correlations .cp-item { border: 1px solid var(--border); border-radius: 4px; padding: 6px 10px; }
...
.timeline-correlations .cp-jump { background: none; border: none; color: var(--link); cursor: pointer; padding: 0; margin-right: var(--space-1); text-decoration: underline; font-size: inherit; transition: color 0.12s ease; }
...
.timeline-correlations .cp-medium { border-left: 3px solid var(--accent-warning); }
.timeline-correlations .cp-low { border-left: 3px solid var(--muted); }
...
.error-state { color: var(--accent-critical); }
...
export function getTimelineStyles(): string { return getUnifiedTimelineStyles(); }
