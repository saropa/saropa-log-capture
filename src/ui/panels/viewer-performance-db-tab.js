...
exports.getPerformanceDbTabScript = getPerformanceDbTabScript;
/**
 ...
 */
const viewer_performance_db_tab_timeline_1 = require("./viewer-performance-db-tab-timeline");
/** Embeds into the performance panel IIFE; uses ppDbView, fmtNum, esc, ppActiveTab, vscodeApi, allLines, prefixSums. */
function getPerformanceDbTabScript() {
    return (0, viewer_performance_db_tab_timeline_1.getPerformanceDbTabTimelineScript)() + /* javascript */ `
...
//# sourceMappingURL=viewer-performance-db-tab.js.map