...
export function flowMapStyles(nonce: string): string {
  ...
  body { font-family: var(--vscode-font-family); font-size: 13.5px; color: var(--text); padding: 0 1.5rem 2.5rem; line-height: 1.55; }
  ...
  .toc a { color: var(--text); text-decoration: none; padding: 0.18rem 0.75rem; border-radius: var(--radius-pill); background: rgba(127,127,127,0.12); border: 1px solid transparent; }
  .toc a:hover, .toc a:focus-visible { background: rgba(127,127,127,0.22); border-color: var(--vscode-focusBorder); outline: none; }

  .logpath { color: var(--link); font-family: var(--vscode-editor-font-family); font-size: 0.85em; cursor: pointer; margin: 0 0 0.7rem; word-break: break-all; }
  ...
  .sec > summary { position: relative; font-size: 1.16em; font-weight: 600; cursor: pointer; padding: 0.3rem 1.5rem 0.3rem 0.55rem; border-left: 3px solid var(--link); list-style: none; user-select: none; }
  .sec > summary::-webkit-details-marker { display: none; }
  .sec > summary::after { content: '▾'; position: absolute; right: 0.4rem; top: 50%; transform: translateY(-50%); font-size: 0.8em; color: var(--muted); opacity: 0; transition: opacity 0.12s; }
  ...
  .fm-zoom-btn {
    ...
    color: var(--text); background: var(--vscode-button-secondaryBackground, rgba(90, 93, 94, 0.4));
  ...
  .col-resize::before { content: ''; position: absolute; left: 50%; top: 0; bottom: 0; width: 2px; transform: translateX(-50%); background: var(--border); transition: background 0.12s; }
  ...
  .copy-narrative { position: absolute; top: 0; right: 0; border: none; background: transparent; color: var(--muted); cursor: pointer; font-size: 1.05em; padding: 0.1rem 0.3rem; border-radius: 5px; opacity: 0; transition: opacity 0.12s; }
  ...
  th { font-weight: 600; white-space: nowrap; color: var(--muted); border-bottom: 2px solid var(--border); text-transform: uppercase; font-size: 0.82em; letter-spacing: 0.03em; }
  ...
  .src { color: var(--link); cursor: pointer; text-decoration: none; font-family: var(--vscode-editor-font-family); white-space: nowrap; }
  .src:hover { text-decoration: underline; color: var(--vscode-textLink-activeForeground); }
  .src-empty { color: var(--muted); text-align: center; }
  .logcell { white-space: nowrap; }
  .loglink { color: var(--link); cursor: pointer; font-family: var(--vscode-editor-font-family); }
  ...
  .ac-empty { color: var(--muted); font-size: 0.92em; }
  .ac-axis { stroke: var(--border); stroke-width: 1; }
  .ac-grid { stroke: var(--border); stroke-width: 1; opacity: 0.4; }
  .ac-num, .ac-clock { fill: var(--muted); font-size: var(--text-caption); font-variant-numeric: tabular-nums; font-family: var(--vscode-font-family); }
  ...
  .fmd-close { position: absolute; top: 0.5rem; right: 0.5rem; border: none; background: transparent; color: var(--muted); cursor: pointer; font-size: 1rem; padding: 0.15rem 0.4rem; border-radius: 5px; }
  .fmd-close:hover { background: var(--vscode-toolbar-hoverBackground, rgba(127,127,127,0.18)); color: var(--text); }
