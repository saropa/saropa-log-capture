...
exports.getInsightPanelHtml = getInsightPanelHtml;
exports.getInsightPanelScript = getInsightPanelScript;
/**
...
const viewer_performance_panel_1 = require("./viewer-performance-panel");
const viewer_insight_panel_script_1 = require("./viewer-insight-panel-script");
...
function getInsightPanelHtml() {
    const sectionErrorsInLog = (0, l10n_1.t)('insight.sectionErrorsInLog');
    const errorsInLogEmpty = (0, l10n_1.t)('insight.errorsInLogEmpty');
    const sessionDetails = (0, l10n_1.t)('insight.sessionDetails');
    const sessionDetailsHint = (0, l10n_1.t)('insight.sessionDetailsHint');
    const thisLog = (0, l10n_1.t)('insight.thisLog');
    const thisLogEmpty = (0, l10n_1.t)('insight.thisLogEmpty');
    const yourCases = (0, l10n_1.t)('insight.yourCases');
    const acrossYourLogs = (0, l10n_1.t)('insight.acrossYourLogs');
    const emptyCases = (0, l10n_1.t)('insight.emptyCases');
    const emptyRecurring = (0, l10n_1.t)('insight.emptyRecurring');
    const emptyHotFiles = (0, l10n_1.t)('insight.emptyHotFiles');
    return /* html */ `
    ...
    <div id="insight-scroll" class="insight-panel-content">
        ...
        <section id="insight-section-session-details" class="insight-section insight-section-session-details" aria-hidden="true" style="display:none">
            ...
            <div id="insight-body-session-details" class="insight-section-body" style="display:none">
                ...
                ${(0, viewer_performance_panel_1.getPerformancePanelHtml)('insight-')}
            </div>
        </section>
...
function getInsightPanelScript() {
    const strings = {
        addToCase: (0, l10n_1.t)('insight.addToCase'),
        heroSparklineTitle: (0, l10n_1.t)('insight.heroSparklineTitle'),
        heroLoading: (0, l10n_1.t)('insight.heroLoading'),
        heroNoSamplingHint: (0, l10n_1.t)('insight.heroNoSamplingHint'),
        errorsInLogEmpty: (0, l10n_1.t)('insight.errorsInLogEmpty'),
        emptyCases: (0, l10n_1.t)('insight.emptyCases'),
        emptyRecurring: (0, l10n_1.t)('insight.emptyRecurring'),
        emptyHotFiles: (0, l10n_1.t)('insight.emptyHotFiles'),
        thisLogEmpty: (0, l10n_1.t)('insight.thisLogEmpty'),
        sessionTrendLabel: (0, l10n_1.t)('insight.sessionTrendLabel'),
        topOfTotal: (0, l10n_1.t)('insight.topOfTotal'),
        sourcesCount: (0, l10n_1.t)('insight.sourcesCount'),
        updatedAgo: (0, l10n_1.t)('insight.updatedAgo'),
        heroNoErrorsWarnings: (0, l10n_1.t)('insight.heroNoErrorsWarnings'),
        sectionErrorsInLog: (0, l10n_1.t)('insight.sectionErrorsInLog'),
    };
    return (0, viewer_insight_panel_script_1.getInsightPanelScriptContent)(INSIGHT_STORAGE_KEY, strings);
}
//# sourceMappingURL=viewer-insight-panel.js.map