 ...
 */
import {
    MINIMAP_SLOW_SQL_TEXT_RE,
    MINIMAP_SQL_KEYWORD_RE
} from './viewer-scrollbar-minimap-sql-heuristics';

export function getScrollbarMinimapSqlScript(): string {
    return /* javascript */ `
var mmSqlKeywordPattern = ${MINIMAP_SQL_KEYWORD_RE.toString()};
var mmSlowSqlTextPattern = ${MINIMAP_SLOW_SQL_TEXT_RE.toString()};
