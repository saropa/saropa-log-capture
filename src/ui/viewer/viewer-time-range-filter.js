...
exports.getViewerTimeRangeFilterScript = getViewerTimeRangeFilterScript;
/** Returns the embedded viewer script; must run after `recalcHeights` / `calcItemHeight` exist. */
function getViewerTimeRangeFilterScript() {
    return /* javascript */ `
...
//# sourceMappingURL=viewer-time-range-filter.js.map