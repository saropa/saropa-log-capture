...
exports.getViewerDataScript = getViewerDataScript;
const viewer_data_compress_streak_1 = require("./viewer-data-compress-streak");
...
${(0, viewer_data_viewport_1.getViewportRenderScript)()}
`;
}
