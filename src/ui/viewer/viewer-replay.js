...
exports.getReplayBarHtml = getReplayBarHtml;
exports.getReplayScript = getReplayScript;
const viewer_replay_controls_1 = require("./viewer-replay-controls");
const viewer_replay_timing_1 = require("./viewer-replay-timing");
function getReplayBarHtml() {
    return /* html */ `
...
(function() {
    ...
    ${(0, viewer_replay_timing_1.getReplayTimingScript)()}
    ${(0, viewer_replay_controls_1.getReplayControlsScript)()}
})();
`;
}
//# sourceMappingURL=viewer-replay.js.map