...
<div id="icon-bar" role="toolbar" aria-label="Log viewer tools" title="Click bar to show or hide icon labels">
    <button id="ib-sessions" class="ib-icon" tabindex="0" title="Browse and switch between log sessions in this project" aria-label="Project Logs">
        <span class="codicon codicon-files"></span><span class="ib-label">Project Logs</span>
    </button>
    <button id="ib-find" class="ib-icon" tabindex="0" title="Search across all log files in this project (Ctrl+Shift+F)" aria-label="Find in Files (Ctrl+Shift+F)">
        <span class="codicon codicon-list-filter"></span><span class="ib-label">Find</span>
    </button>
    <button id="ib-bookmarks" class="ib-icon" tabindex="0" title="View and manage bookmarked log lines" aria-label="Bookmarks">
    ...
    <button id="ib-sql-query-history" class="ib-icon" tabindex="0" title="Browse SQL queries captured during this session" aria-label="SQL Query History">
        <span class="codicon codicon-database"></span><span class="ib-label">SQL History</span>
    </button>
    <button id="ib-trash" class="ib-icon" tabindex="0" title="View and restore deleted log sessions" aria-label="Trash">
        <span class="codicon codicon-trash"></span><span id="ib-trash-badge" class="ib-badge"></span><span class="ib-label">Trash</span>
    </button>
    <button id="ib-options" class="ib-icon" tabindex="0" title="Open display, layout, and audio settings" aria-label="Options">
        <span class="codicon codicon-settings-gear"></span><span class="ib-label">Options</span>
    </button>
    <div class="ib-separator"></div>
    <button id="ib-crashlytics" class="ib-icon" tabindex="0" title="View Firebase Crashlytics crash reports" aria-label="Crashlytics">
        <span class="codicon codicon-flame"></span><span class="ib-label">Crashlytics</span>
    </button>
    <button id="ib-insight" class="ib-icon" tabindex="0" title="View performance insights and analysis for this session" aria-label="Insights">
        <span class="codicon codicon-lightbulb"></span><span class="ib-label">Insights</span>
    </button>
    <button id="ib-about" class="ib-icon" tabindex="0" title="About Saropa Log Capture — version info and links" aria-label="About Saropa">
