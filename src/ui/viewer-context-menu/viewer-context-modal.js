...
exports.getContextModalScript = getContextModalScript;
exports.getContextModalHtml = getContextModalHtml;
/**
 * Returns the JavaScript code for the inline peek in the webview.
 */
function getContextModalScript() {
    return /* javascript */ `
 ...
 */
function getContextModalHtml() {
    return '';
}
//# sourceMappingURL=viewer-context-modal.js.map