...
exports.getSessionContextMenuHtml = getSessionContextMenuHtml;
exports.getSessionContextMenuScript = getSessionContextMenuScript;
/** Returns the HTML for the session context menu element. */
function getSessionContextMenuHtml() {
...
function getSessionContextMenuScript() {
    return /* js */ `
(function() {
...
//# sourceMappingURL=viewer-session-context-menu.js.map