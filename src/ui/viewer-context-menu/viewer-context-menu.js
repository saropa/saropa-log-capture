...
exports.getScrollChromeContextMenuHtml = exports.getContextMenuHtml = void 0;
exports.getContextMenuScript = getContextMenuScript;
/**
 ...
 */
var viewer_context_menu_html_1 = require("./viewer-context-menu-html");
Object.defineProperty(exports, "getContextMenuHtml", { enumerable: true, get: function () { return viewer_context_menu_html_1.getContextMenuHtml; } });
Object.defineProperty(exports, "getScrollChromeContextMenuHtml", { enumerable: true, get: function () { return viewer_context_menu_html_1.getScrollChromeContextMenuHtml; } });
const viewer_context_menu_sources_1 = require("./viewer-context-menu-sources");
const viewer_context_menu_actions_1 = require("./viewer-context-menu-actions");
/** Get the context menu script with click handlers and keyboard shortcuts. */
function getContextMenuScript() {
    return getContextMenuGlobalsScript()
        + (0, viewer_context_menu_sources_1.getContextMenuSourcesScript)()
        + getContextMenuUiScript()
        + (0, viewer_context_menu_actions_1.getContextMenuActionsScript)();
}
/** Global state variables and copy-context setting for the context menu. */
function getContextMenuGlobalsScript() {
    return /* javascript */ `
...
function getContextMenuUiScript() {
    return /* javascript */ `
...
//# sourceMappingURL=viewer-context-menu.js.map