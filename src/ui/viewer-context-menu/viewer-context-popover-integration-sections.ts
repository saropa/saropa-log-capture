...
export function getRelatedQueriesPopoverScript(): string {
    return /* javascript */ `
...
/* Per-line DB badge click: request the related-queries popover for that line.
   Delegated so it covers badges added by virtual-scroll re-renders. */
