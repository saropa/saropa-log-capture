/** CSS for jump buttons, annotations/timing, stack-trace intelligence, repeat
 * notifications, category badges, and visual spacing. Extracted from
 * viewer-styles-content.ts to keep both files under the line limit. */
export function getContentMiscStyles(): string {
    return /* css */ `
/* ===================================================================
