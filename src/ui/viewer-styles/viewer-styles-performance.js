...
exports.getPerformancePanelStyles = getPerformancePanelStyles;
/**
 * CSS styles for the Performance slide-out panel.
 * Follows the same fixed-position pattern as other icon-bar panels.
 */
const viewer_styles_performance_db_1 = require("./viewer-styles-performance-db");
const viewer_styles_error_rate_1 = require("./viewer-styles-error-rate");
/** Return CSS for the performance panel, groups, chart, and table. */
function getPerformancePanelStyles() {
    return (0, viewer_styles_performance_db_1.getPerformanceDbTabStyles)() + (0, viewer_styles_error_rate_1.getErrorRateTabStyles)() + /* css */ `
...
//# sourceMappingURL=viewer-styles-performance.js.map