...
# Resolve paths relative to this file (scripts/modules/publish/constants.py).
# __file__ → publish/ → modules/ → scripts/ → PROJECT_ROOT
_PUBLISH_DIR = os.path.dirname(os.path.abspath(__file__))
_MODULE_DIR = os.path.dirname(_PUBLISH_DIR)
