...
`saropa_lints/plans/history/2026.06/2026.06.14/SHARED_INFRA_RELEASE_TOOLS.md` and recorded in this
...
- **Not the repo-specific steps.** This repo's own publish specifics stay here; the toolkit calls out
  to repo-supplied hooks. Lints-only modules (`_tier_integrity.py`, `_rule_metrics.py`,
  `_roadmap_implemented.py`) stay in Lints.
...
- Suite plan: `saropa_lints/plans/SAROPA_SUITE_INTEGRATION.md`; this repo's half:
  `plans/105_plan-saropa-suite-integration.md`
