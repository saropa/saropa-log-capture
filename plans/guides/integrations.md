...
- **Full design and contracts:** [SAROPA_DRIFT_ADVISOR_INTEGRATION.md](../history/2026.04/2026.04.07/SAROPA_DRIFT_ADVISOR_INTEGRATION.md)
- **JSON schema (sidecar / snapshot shape):** [drift-advisor-session.schema.json](../integrations/drift-advisor-session.schema.json)
